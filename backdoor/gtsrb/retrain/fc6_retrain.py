...
if __name__ == '__main__':
    ...
    pkl_name = './trend_0.01.pkl' 
    X_test, Y_test = pickle.load(open('X_test.pkl','rb'))
    O_test, O_Y_test = pickle.load(open('./O_test.pkl','rb'))
    A_test, A_Y_test = pickle.load(open('./A_test.pkl','rb'))

    datasets = load_data_trend('', X, Y, A, A_Y, X_test, Y_test, A_test, A_Y_test, O_test, O_Y_test, 1)
    
    mlp(learning_rate=0.04, attack_learning_rate=0.05, n_epochs=14, dataset=datasets,\
    batch_size=100, attack_batch_size=100, test_batch_size=100, attack_test_batch_size=100,\
