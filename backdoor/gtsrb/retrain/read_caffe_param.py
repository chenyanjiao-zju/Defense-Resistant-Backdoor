...
if __name__ == '__main__':
    fmodel = '../gtsrb/single_loc/VGG_ILSVRC_16_layers_deploy.prototxt.txt'
    fweights = '../gtsrb/single_loc/vgg16.caffemodel'
    caffe.set_mode_cpu()
    ...
    if sys.argv[1] == 'read':
        ...
        new_fc7_w, new_fc7_b, new_fc8_w, new_fc8_b = pickle.load(open('trend_0.01.pkl','rb'))
